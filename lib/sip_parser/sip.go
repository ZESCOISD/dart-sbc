...
func getString(sl String, from, to int) string {
...
// Checks the bounds to avoid any range errors
func getBytes(sl String, from, to int) String {
	// Remove negative values
	if from < 0 {
	    from = 0
	}
...
// Function to print all we know about the  in a readable format
